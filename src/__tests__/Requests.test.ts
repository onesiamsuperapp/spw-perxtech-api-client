import { PerxTransactionRequestData, PerxTransactionReqeust, PerxLoyaltyTransactionRequestUserAccount, PerxRawUserAccountId, PerxRawUserAccountIdentifier, PerxLoyaltyTransactionReservationRequest, PerxLoyaltyTransactionRequest, PerxInvoiceRequestUsedItem, PerxInvoiceRequestTransactionData, PerxInvoiceRequestTransactionDataRaw, PerxInvoiceRequest, PerxRawUserAccount } from '../models'
...
describe('PerxTransactionRequestData', () => {
  test('should init with default value', () => {
    ...
    const perxRequestData = new PerxTransactionRequestData(123, 'THB', 'transaction-ref-001')
...
describe('PerxTransactionReqeust', () => {
  test('should init with default value', () => {
    ...
    const perxRequest = new PerxTransactionReqeust(userAccountId, perxRequestData)
  ...
  test('should be call PerxTransactionRequestData and PerxTransactionReqeust makePurchase', () => {
    const userAccountId = 'user-account-001'
    const perxRequest = PerxTransactionReqeust.makePurchase(userAccountId, 123, 'THB', 'transaction-ref-001')
  ...
  test('should be call PerxTransactionRequestData and PerxTransactionReqeust makeCustomTransaction', () => {
    const userAccountId = 'user-account-001'
    const perxRequest = PerxTransactionReqeust.makeCustomTransaction('purchase', userAccountId, 1234, 'THB', 'transaction-ref-001', undefined, new Date())
    expect(perxRequest).toBeInstanceOf(PerxTransactionReqeust);
  })
  ...
  test('should be call PerxTransactionRequestData and PerxTransactionReqeust test', () => {
    ...
    const perxRequest = PerxTransactionReqeust.makeCustomTransaction('purchase-fix', userAccountId, 5432, 'THB', 'transaction-ref-002', input, new Date())
    expect(perxRequest).toBeInstanceOf(PerxTransactionReqeust);
  })
})
...
describe('PerxLoyaltyTransactionRequestUserAccount', () => {
  test('should be return id when init type id', () => {
    ...
    const perxRequestUserAccount = new PerxLoyaltyTransactionRequestUserAccount(perxUserAccountId)
  ...
  test('should be return identifier when init identifier', () => {
    ...
    const perxRequestUserAccount = new PerxLoyaltyTransactionRequestUserAccount(perxUserAccountIdentifier)
    expect(perxRequestUserAccount).toEqual(expected)
  })
})
...
describe('PerxLoyaltyTransactionReservationRequest', () => {
  test('should init with default value', () => {
    ...
    const perxRequestUserAccount = new PerxLoyaltyTransactionReservationRequest(perxUserAccountIdentifier, 1234, 50)
    expect(perxRequestUserAccount).toEqual(expected)
  })
})
...
describe('PerxLoyaltyTransactionRequest', () => {
  test('should init with default value', () => {
    ...
    const perxRequestUserAccount = new PerxLoyaltyTransactionRequest(perxUserAccountIdentifier, 1234, 50, 'transaction-ref-0001')
    expect(perxRequestUserAccount).toEqual(expected)
  })
  ...
  test('should be return this', () => {
    ...
    const perxRequestUserAccount = new PerxLoyaltyTransactionRequest(perxUserAccountIdentifier, 1234, 50, 'transaction-ref-0001')
    const resultTransactionType = perxRequestUserAccount.withTransactionType('purchase')
  ...
  test('should be return points negative when call makeBurnRequest', () => {
    ...
    const resultMakeBurn = PerxLoyaltyTransactionRequest.makeBurnRequest(perxUserAccountIdentifier, 4567, 200)
  ...
  test('should be return points positive when call makeBurnRequest', () => {
    ...
    const resultMakeBurn = PerxLoyaltyTransactionRequest.makeEarnRequest(perxUserAccountIdentifier, 4567, 100)
    expect(resultMakeBurn).toEqual(expected)
  })
  ...
  describe('PerxInvoiceRequestUsedItem', () => {
    test('should init with default value', () => {
      ...
      const perxInvoiceRequestUsedItem = new PerxInvoiceRequestUsedItem('Reward::Transaction', 12345)
    ...
    test('should be return reward with PerxInvoiceRequestUsedItem', () => {
      ...
      const perxInvoiceRequestUsedItem = PerxInvoiceRequestUsedItem.reward(1234)
      expect(perxInvoiceRequestUsedItem).toEqual(expected)
    })
  })
  ...
  describe('PerxInvoiceRequestTransactionData', () => {
    test('should init with default value', () => {
      ...
      const perxInvoiceRequestTransactionData = new PerxInvoiceRequestTransactionData(200, 'merchant-0001', input)
  ...
  describe('PerxInvoiceRequest', () => {
    test('should init with default value', () => {
      ...
      const perxInvoiceInvoiceRequest = new PerxInvoiceRequest(perxUserAccountIdentifier)
    ...
    test('should init with default value pass type PerxLoyaltyTransactionRequestUserAccount', () => {
      ...
      const perxLoyaltyTransactionRequestUserAccount = new PerxLoyaltyTransactionRequestUserAccount(perxUserAccountIdentifier)
      const expected = {
        transactionData: [],
        usedItems: [],
    ...
    test('should be return this when call addTransactions', () => {
      ...
      const perxInvoiceInvoiceRequest = new PerxInvoiceRequest(perxUserAccountIdentifier)
      const resultTransaction = perxInvoiceInvoiceRequest.addTransactions(perxInvoiceRequestTransactionData1, perxInvoiceRequestTransactionData2)
    ...
    test('should be return this when call used', () => {
      ...
      const perxInvoiceInvoiceRequest = new PerxInvoiceRequest(perxUserAccountIdentifier)
      const perxInvoiceRequestUsedItem1 = new PerxInvoiceRequestUsedItem('Reward::Transaction', 1234)
      const perxInvoiceRequestUsedItem2 = new PerxInvoiceRequestUsedItem('StoredValue::Transaction', 5678)
      const resultTransaction = perxInvoiceInvoiceRequest.used(perxInvoiceRequestUsedItem1, perxInvoiceRequestUsedItem2)
      expect(resultTransaction).toEqual(expected)
    })
  })
})